...
let region_select = document.getElementById("regiones");
...
const updateComunas = () => {
    const selected_region = document.getElementById("regiones");
    ...
    const selected_comuna = document.getElementById("comunas");
...
region_select.addEventListener('change', updateComunas);
